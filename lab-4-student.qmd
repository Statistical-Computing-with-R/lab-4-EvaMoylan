...
ca_childcare |>
  ...
  labs(x = "Weekly Median Price for Center-Based Infant Childcare ($)",
       y = NULL,
       title = "California Median Household Income (2018 $) Based on Infant Childcare Cost")
...
reg_mod1 <- lm(formulat = mhi_2018 ~ mc_infant, 
               data = ca_childcare)
