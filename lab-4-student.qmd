  ...
  mutate(county_name = str_remove(county_name, "County"),
         region = fct_collapse(county_name,
                               ...
                               "San Francisco Bay Area" = c("Alameda", 
                                                            ...
                                                            "Solano", 
                                                            "Sonoma"),
                               "Northern San Joaquin Valley" = c("San Joaquin", 
                                                                 "Stanislaus", 
                                                                 "Merced"),
                               "Sacramento Area" = c("El Dorado", 
                                                     "Placer", 
                                                     "Sacramento", 
                                                     "Sutter", 
                                                     "Yolo", 
                               ...
                               "Central Coast" = c("Monterey", 
                                                   ...
                                                   "Santa Cruz", 
                                                   "Ventura"),
                               "Northern California & Central Sierra" = c("Alpine", 
                                                                          "Amador", 
                                                                          "Calaveras", 
                                                                          "Inyo", 
                                                                          "Mariposa", 
                               ...
                               "Inland Empire" = c("Riverside", 
                                                   "San Bernardino"),
                               "San Diego Area" = c("San Diego", 
                                                    "Imperial")
                               ))
  
# View the data frame with the new 'region' column
ca_childcare
```
...
ca_childcare |>
  ...
  pivot_wider(id_cols = "region", #region stays from original table orientation 
              ...
              values_from = c(mhi_2018,
                              mc_infant)) |> 
  slice_min(mc_infant_2018) #What region has the lowest median childcare for infants in 2018?
