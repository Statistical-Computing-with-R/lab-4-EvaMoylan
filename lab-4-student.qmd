...
```
*Question 6 Revision: changed order of facet, changed axis text and point size to fit better, changed aspect ratio, made color palette*
...
summary(reg_mod1)
```
*Question 8 Revision: flipped variables!*
