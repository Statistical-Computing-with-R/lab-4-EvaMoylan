...
*Question 1 Reflection: added context of the data, first sentence*
...
```
*Question 6 Reflection: changed order of facet, changed axis text and point size to fit better, changed aspect ratio, made color palette*
